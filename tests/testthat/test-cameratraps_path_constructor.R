...
df <- data.frame(
  ...
  expect_equal(extract_site_code_from_collection_folder(collection_folder = "WCT_05152018_06112018"), df)
})
...
test_that("5-letter site code collection folders parse", {
  ...
  expect_equal(extract_site_code_from_collection_folder(collection_folder = "BUT12_20210527_20210622"), df)
})
...
test_that("1-letter and 2 digit site code collection folders parse", {
  ...
  expect_equal(extract_site_code_from_collection_folder(collection_folder = "A51_05282021_06222021"), df)
})
...
test_that("3-letter and '5_min' site code collection folders parse", {
  ...
  expect_equal(extract_site_code_from_collection_folder(collection_folder = "WCS_5min_05212019_06032019"), df)
})
...
test_that("3-digit site code collection folders return NA", {
  ...
  expect_equal(extract_site_code_from_collection_folder(collection_folder = "123_05212019_06032019"), df)
})
