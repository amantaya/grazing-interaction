...
ggplot(veg_data, aes(fill = Type, y = mean, x = site)) +
  ...
  labs(title = "White Mountain Vegetation Utilization", subtitle = "2017-2019") +
  ...
  scale_y_continuous(breaks = c(seq(1000, 6000, by = 1000))) +
  annotate(geom = "text", x = 1.1, y = 6000, label = paste0(utilization[1], "%")) +
  annotate(geom = "text", x = 2.1, y = 4700, label = paste0(utilization[2], "%")) +
  annotate(geom = "text", x = 3.1, y = 4200, label = paste0(utilization[3], "%")) +
  annotate(geom = "text", x = 4.1, y = 5900, label = paste0(utilization[4], "%")) +
  annotate(geom = "text", x = 5.1, y = 4200, label = paste0(utilization[5], "%")) +
  annotate(geom = "text", x = 6.1, y = 5800, label = paste0(utilization[6], "%"))

#ggsave("Utilization-Across-Year-Comparison-Error-Bars.jpg", 
