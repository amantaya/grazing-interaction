...
ggplot(veg_data, aes(fill = Type, y = mean, x = site)) +
  ...
  annotate(geom = "text", x = 1.1, y = -500, label = paste0(utilization[1], "%")) +
  annotate(geom = "text", x = 2.1, y = -500, label = paste0(utilization[2], "%")) +
  annotate(geom = "text", x = 3.1, y = -500, label = paste0(utilization[3], "%")) +
  annotate(geom = "text", x = 4.1, y = -500, label = paste0(utilization[4], "%")) +
  annotate(geom = "text", x = 5.1, y = -500, label = paste0(utilization[5], "%")) +
  annotate(geom = "text", x = 6.1, y = -500, label = paste0(utilization[6], "%"))
  
ggsave("Utilization-Across-Year-Comparison-Values-Under-Bars.jpg", 
