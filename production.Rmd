...
mystats[1, 6] <- 10*(mean(BGW17E$TotalDry)-2.571*se(BGW17E$TotalDry))
mystats[2, 6] <- 10*(mean(BGW17G$TotalDry)-2.571*se(BGW17G$TotalDry))
mystats[3, 6] <- 10*(mean(WCS17E$TotalDry)-2.571*se(WCS17E$TotalDry))
mystats[4, 6] <- 10*(mean(WCS17G$TotalDry)-2.571*se(WCS17G$TotalDry))
mystats[5, 6] <- 10*(mean(BGW18E$TotalDry)-2.571*se(BGW18E$TotalDry))
mystats[6, 6] <- 10*(mean(BGW18G$TotalDry)-2.571*se(BGW18G$TotalDry))
mystats[7, 6] <- 10*(mean(WCS18E$TotalDry)-2.571*se(WCS18E$TotalDry))
mystats[8, 6] <- 10*(mean(WCS18G$TotalDry)-2.571*se(WCS18G$TotalDry))

## Upper 95% confidence intervals of the production mean
mystats[1, 7] <- 10*(mean(BGW17E$TotalDry)+2.571*se(BGW17E$TotalDry))
mystats[2, 7] <- 10*(mean(BGW17G$TotalDry)+2.571*se(BGW17G$TotalDry))
mystats[3, 7] <- 10*(mean(WCS17E$TotalDry)+2.571*se(WCS17E$TotalDry))
mystats[4, 7] <- 10*(mean(WCS17G$TotalDry)+2.571*se(WCS17G$TotalDry))
mystats[5, 7] <- 10*(mean(BGW18E$TotalDry)+2.571*se(BGW18E$TotalDry))
mystats[6, 7] <- 10*(mean(BGW18G$TotalDry)+2.571*se(BGW18G$TotalDry))
mystats[7, 7] <- 10*(mean(WCS18E$TotalDry)+2.571*se(WCS18E$TotalDry))
mystats[8, 7] <- 10*(mean(WCS18G$TotalDry)+2.571*se(WCS18G$TotalDry))
...
```{r}
jpeg(filename = "figures/vegetation/Boggy Creek Utilization 2017.jpg",
     width=12,
     height=12,
     units="in",
     res=300)
...
```{r}
jpeg(filename = "figures/vegetation/Boggy Creek Utilization 2018.jpg",
     width=12,
     height=12,
     units="in",
     res=300)
...
```{r}
jpeg(filename = "figures/vegetation/Wildcat Creek Utilization 2017.jpg",
     width=12,
     height=12,
     units="in",
     res=300)
...
```{r}
jpeg(filename = "figures/vegetation/Wildcat Creek Utilization 2018.jpg",
     width=12,
     height=12,
     units="in",
     res=300)
