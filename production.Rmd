...
The "reordered" data was re-ordered so that all of the data from the exclosures frames were grouped together. This was a pre-processing step during the clean-up phase of analysis.
```{r}
## read in data
...
For Wildcat, instead of clipping the entire 1m X 1m grazing exclosure, we clipped a 40cm x 40 cm quadrat randomly placed inside of the exclosure. We decided to clip a smaller area to save time.
This differs from how we clipped the Boggy Creek site for the same year. We clipped the entire 1m x 1m exclosure.
