...
#'
#' @param sitecode_df A data frame that contains a column named `site_code` and
#'   (optionally) a column named `collection_folder`. This data frame is usually
#'   generated by the function `extract_site_code_from_collection_folder()`.
#'
#' @param path A string that is a valid file path to the location of the
#'   top-level folder of the 'cameratraps' or 'cameratraps2' folders.
#'
