...
#'   * `sub_folder` corresponds to the sub-folder create by the cameratrap,
#'      e.g. 100EK113.
...
#'   )
#'
#'   cameratraps_folders_to_match_df <- data.frame(
...
#'   )
#'   subject_text_files_to_cameratraps_path(subject_txt_df, cameratraps_folders_to_match_df)
#'
#' @export
