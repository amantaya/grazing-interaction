...
BGW17RAW<-readr::read_csv('data/photo/BGW_Analysis_2017.csv', col_names = TRUE, na = c(""," ","NA"))
WCS17RAW<-readr::read_csv('data/photo/WCS_Analysis_2017.csv', col_names = TRUE, na = c(""," ","NA"))
...
BGX18RAW<-readr::read_csv('data/photo/BGX_Analysis_2018.csv', col_names = TRUE, na = c(""," ","NA"))
BGW18RAW<-readr::read_csv('data/photo/BGW_Analysis_2018.csv', col_names = TRUE, na = c(""," ","NA"))
BGT18RAW<-readr::read_csv('data/photo/BGT_Analysis_2018.csv', col_names = TRUE, na = c(""," ","NA"))
WCX18RAW<-readr::read_csv('data/photo/WCX_Analysis_2018.csv', col_names = TRUE, na = c(""," ","NA"))
WCS18RAW<-readr::read_csv('data/photo/WCS_Analysis_2018.csv', col_names = TRUE, na = c(""," ","NA"))
WCT18RAW<-readr::read_csv('data/photo/WCT_Analysis_2018.csv', col_names = TRUE, na = c(""," ","NA"))
...
```{r}
# read in the 2019 data, treating all blanks, spaces, and "NA"s as NA's
A51_2019_RAW <- readr::read_csv("data/photo/A51_2019.csv", col_names = TRUE, na = c(""," ","NA"))
BKD_2019_RAW <- readr::read_csv("data/photo/BKD_2019.csv", col_names = TRUE, na = c(""," ","NA"))
BKN_2019_RAW <- readr::read_csv("data/photo/BKN_2019.csv", col_names = TRUE, na = c(""," ","NA"))
BKS_2019_RAW <- readr::read_csv("data/photo/BKS_2019.csv", col_names = TRUE, na = c(""," ","NA"))
BRL_2019_RAW <- readr::read_csv("data/photo/BRL_2019.csv", col_names = TRUE, na = c(""," ","NA"))
BRT_2019_RAW <- readr::read_csv("data/photo/BRT_2019.csv", col_names = TRUE, na = c(""," ","NA"))
...
A51_2020_RAW <- readr::read_csv("data/photo/A51_2020.csv", col_names = TRUE, na = c(""," ","NA"))
BKN_2020_RAW <- readr::read_csv("data/photo/BKN_2020.csv", col_names = TRUE, na = c(""," ","NA"))
BKS_2020_RAW <- readr::read_csv("data/photo/BKS_2020.csv", col_names = TRUE, na = c(""," ","NA"))
BRL_2020_RAW <- readr::read_csv("data/photo/BRL_2020.csv", col_names = TRUE, na = c(""," ","NA"))
...
ACH19<- test[complete.cases(test[ , 'Count1Species']),]

A51_2019 <- A51_2019_RAW[complete.cases(A51_2019_RAW[ , 'Count1Species']),]
A51_2020 <- A51_2020_RAW[complete.cases(A51_2020_RAW[ , 'Count1Species']),]
BKD_2019 <- BKD_2019_RAW[complete.cases(BKD_2019_RAW[ , 'Count1Species']),]
BKD_2020 <- BKD_2020_RAW[complete.cases(BKD_2020_RAW[ , 'Count1Species']),]
BKN_2019 <- BKN_2019_RAW[complete.cases(BKN_2019_RAW[ , 'Count1Species']),]
BKN_2020 <- BKN_2020_RAW[complete.cases(BKN_2020_RAW[ , 'Count1Species']),]
BKS_2019 <- BKS_2019_RAW[complete.cases(BKS_2019_RAW[ , 'Count1Species']),]
BKS_2020 <- BKS_2020_RAW[complete.cases(BKS_2020_RAW[ , 'Count1Species']),]
BRL_2019 <- BRL_2019_RAW[complete.cases(BRL_2019_RAW[ , 'Count1Species']),]
BRL_2020 <- BRL_2020_RAW[complete.cases(BRL_2020_RAW[ , 'Count1Species']),]
BRT_2019 <- BRT_2019_RAW[complete.cases(BRT_2019_RAW[ , 'Count1Species']),]
BRT_2020 <- BRT_2020_RAW[complete.cases(BRT_2020_RAW[ , 'Count1Species']),]
```
***
...
A51_2019$DateTime <- ymd_hms(A51_2019$DateTime)
A51_2020$DateTime <- ymd_hms(A51_2020$DateTime)
BKD_2019$DateTime <- ymd_hms(BKD_2019$DateTime)
BKD_2020$DateTime <- ymd_hms(BKD_2020$DateTime)
BKN_2019$DateTime <- ymd_hms(BKN_2019$DateTime)
BKN_2020$DateTime <- ymd_hms(BKN_2020$DateTime)
BKS_2019$DateTime <- ymd_hms(BKS_2019$DateTime)
BKS_2020$DateTime <- ymd_hms(BKS_2020$DateTime)
BRL_2019$DateTime <- ymd_hms(BRL_2019$DateTime)
BRL_2020$DateTime <- ymd_hms(BRL_2020$DateTime)
BRT_2019$DateTime <- ymd_hms(BRT_2019$DateTime)
BRT_2020$DateTime <- ymd_hms(BRT_2020$DateTime)
...
***
```{r}
BGT18 <- BGT18 %>% rename(multi = TraitB2)
BGW18 <- BGW18 %>% rename(multi = TraitB2)
BGX18 <- BGX18 %>% rename(multi = TraitB2)

WCS18 <- WCS18 %>% rename(multi = TraitB2)
WCT18 <- WCT18 %>% rename(multi = TraitB2)
WCX18 <- WCX18 %>% rename(multi = TraitB2)
```
***
```{r}
BGT18 <- BGT18 %>% rename(water = Trait4)
BGW18 <- BGW18 %>% rename(water = Trait4)
BGX18 <- BGX18 %>% rename(water = Trait4)

WCS18 <- WCS18 %>% rename(water = Trait4)
WCT18 <- WCT18 %>% rename(water = Trait4)
WCX18 <- WCX18 %>% rename(water = Trait4)
```
...
A51_2019 <- allspecies(A51_2019)
A51_2020 <- allspecies(A51_2020)
BKD_2019 <- allspecies(BKD_2019)
BKD_2020 <- allspecies(BKD_2020)
BKN_2019 <- allspecies(BKN_2019)
BKN_2020 <- allspecies(BKN_2020)
BKS_2019 <- allspecies(BKS_2019)
BKS_2020 <- allspecies(BKS_2020)
BRL_2019 <- allspecies(BRL_2019)
BRL_2020 <- allspecies(BRL_2020)
BRT_2019 <- allspecies(BRT_2019)
BRT_2020 <- allspecies(BRT_2020)
```
***
...
BKD_2020counts <- counts.df(BKD_2020)
...
BRT_2020counts <- counts.df(BRT_2020)
```
***
...
BKD_2020horses <- BKD_2020[BKD_2020$horse >0, ]
BKD_2020cows <- BKD_2020[BKD_2020$cow >0, ]
BKD_2020elk <- BKD_2020[BKD_2020$elk >0, ]
...
BRT_2020horses <- BRT_2020[BRT_2020$horse >0, ]
BRT_2020cows <- BRT_2020[BRT_2020$cow >0, ]
BRT_2020elk <- BRT_2020[BRT_2020$elk >0, ]
...
BKD_2020grouptotals <- group.total(BKD_2020)
...
BRT_2020grouptotals <- group.total(BRT_2020)
```
***
