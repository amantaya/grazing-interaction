...
lag_time_diff2 <- difftime(WCS17horses$DateTime, lag(WCS17horses$DateTime, default = WCS17horses$DateTime[1]), units = "mins")

WCS17horses$group <- cumsum(ifelse(lag_time_diff2>10,1,0))

WCS17horses$group <- WCS17horses$group+1

head(WCS17horses$DateTime)
tail(WCS17horses$DateTime)
```
