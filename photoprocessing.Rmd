...
```{r}
data_2018_all_species <- allspecies(data_2018_rename_col)

View(data_2018_all_species)
```
***
...
```{r}
horses_2018 <- data_2018_all_species %>% dplyr::filter(horse != 0)

print(horses_2018)

BRL_horses_2018 <- horses_2018 %>% dplyr::filter(Site == "Bear Timelapse")
...
```
```{r}
nrow(data_2017_clean_dates)
nrow(data_2018_all_species)
nrow(data_2019_clean_dates)
nrow(data_2020_clean_dates)
```

```{r}
sum(nrow(data_2017_clean_dates), nrow(data_2018_all_species), nrow(data_2019_clean_dates), nrow(data_2020_clean_dates))
```
