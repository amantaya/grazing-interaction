...
```{r}
WCS17Detections<- data.frame(species = c("horses", "cows", "elk"), 
                groups = (c(tail(WCS17horses$group, n = 1), tail(WCS17cows$group, n = 1), tail(WCS17elk$group, n = 1))))

head(WCS17Detections)
```
