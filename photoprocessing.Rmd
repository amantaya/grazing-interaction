...
test<-read.csv('data/photo/HorseImaging_test.csv', header=TRUE, na.strings=c(""," ","NA"))

# BGW18RAW

A51_2019_RAW <- read_csv("data/photo/A51_2019.csv", na = c(""," ","NA"))
A51_2020_RAW <- read_csv("data/photo/A51_2020.csv", na = c(""," ","NA"))
BKD_2019_RAW <- read_csv("data/photo/BKD_2019.csv", na = c(""," ","NA"))
BKD_2020_RAW <- read_csv("data/photo/BKD_2020.csv", na = c(""," ","NA"))
BKN_2019_RAW <- read_csv("data/photo/BKN_2019.csv", na = c(""," ","NA"))
BKN_2020_RAW <- read_csv("data/photo/BKN_2020.csv", na = c(""," ","NA"))
BKS_2019_RAW <- read_csv("data/photo/BKS_2019.csv", na = c(""," ","NA"))
BKS_2020_RAW <- read_csv("data/photo/BKS_2020.csv", na = c(""," ","NA"))
BRL_2019_RAW <- read_csv("data/photo/BRL_2019.csv", na = c(""," ","NA"))
BRL_2020_RAW <- read_csv("data/photo/BRL_2020.csv", na = c(""," ","NA"))
BRT_2019_RAW <- read_csv("data/photo/BRT_2019.csv", na = c(""," ","NA"))
BRT_2020_RAW <- read_csv("data/photo/BRT_2020.csv", na = c(""," ","NA"))
```
***
