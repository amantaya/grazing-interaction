...
heber_2018_stats <- heber_2018_stats  %>% dplyr::mutate(lower_95 = mean - ci)

heber_2018_stats <- heber_2018_stats %>% dplyr::mutate(upper_95 = mean + ci)
...
```{r add confidence intervals bounds 2019}
heber_2019_stats <- heber_2019_stats  %>% dplyr::mutate(lower_95 = mean - ci)

heber_2019_stats <- heber_2019_stats %>% dplyr::mutate(upper_95 = mean + ci)
...
```{r add confidence intervals bounds 2020}
heber_2020_stats <- heber_2020_stats  %>% dplyr::mutate(lower_95 = mean - ci)

heber_2020_stats <- heber_2020_stats %>% dplyr::mutate(upper_95 = mean + ci)
...
```{r 2019 White Mountains Landscape Appearance Figure, }
...
```{r 2019 Heber Landscape Appearance Figure, }
...
```{r 2020 Heber Landscape Appearance Figure}
