...
```{r load data}
path <- file.path(path_to_data_input_folder, "vgs", "2022-04-08-vgs-export.xlsx")
...
```{r}
readr::write_csv(canopy_cover_df, file.path(path_to_user_folder, "grazing_data", "data", "canopy-cover", "2021-heber-canopy-cover.csv"))
```
