...
# docker run -d -e DISABLE_AUTH=true --rm -p 127.0.0.1:8787:8787 -v C:/Users/andre/Dropbox/Dev/grazing-interaction:/home/rstudio/grazing-interaction -v H:/cameratraps:/home/rstudio/cameratraps -v H:/cameratraps2:/home/rstudio/cameratraps2 amantaya/rocker-verse:4.0.5
